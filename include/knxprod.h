...
#define IR_VisibleChannels                     46      // uint8_t

// Verfügbare Kanäle
#define ParamIR_VisibleChannels                     (knx.paramByte(IR_VisibleChannels))

#define IR_ChannelCount 20

// Parameter per channel
#define IR_ParamBlockOffset 47
#define IR_ParamBlockSize 10
#define IR_ParamCalcIndex(index) (index + IR_ParamBlockOffset + _channelIndex * IR_ParamBlockSize)

#define IR_cMode                                0      // 4 Bits, Bit 7-4
#define     IR_cModeMask 0xF0
#define     IR_cModeShift 4
#define IR_cCodeProtocol                        1      // uint8_t
#define IR_cCodeAddress                         2      // uint16_t
#define IR_cCodeCommand                         4      // uint16_t
#define IR_cCodeBits                            6      // uint16_t
#define IR_cCodeExtra                           8      // uint16_t

// Modus
#define ParamIR_cMode                               ((knx.paramByte(IR_ParamCalcIndex(IR_cMode)) & IR_cModeMask) >> IR_cModeShift)
// 
#define ParamIR_cCodeProtocol                       (knx.paramByte(IR_ParamCalcIndex(IR_cCodeProtocol)))
// 
#define ParamIR_cCodeAddress                        (knx.paramWord(IR_ParamCalcIndex(IR_cCodeAddress)))
// 
#define ParamIR_cCodeCommand                        (knx.paramWord(IR_ParamCalcIndex(IR_cCodeCommand)))
// 
#define ParamIR_cCodeBits                           (knx.paramWord(IR_ParamCalcIndex(IR_cCodeBits)))
// 
#define ParamIR_cCodeExtra                          (knx.paramWord(IR_ParamCalcIndex(IR_cCodeExtra)))

// deprecated
#define IR_KoOffset 201

// Communication objects per channel (multiple occurrence)
#define IR_KoBlockOffset 201
#define IR_KoBlockSize 1

#define IR_KoCalcNumber(index) (index + IR_KoBlockOffset + _channelIndex * IR_KoBlockSize)
#define IR_KoCalcIndex(number) ((number >= IR_KoCalcNumber(0) && number < IR_KoCalcNumber(IR_KoBlockSize)) ? (number - IR_KoBlockOffset) % IR_KoBlockSize : -1)
#define IR_KoCalcChannel(number) ((number >= IR_KoBlockOffset && number < IR_KoBlockOffset + IR_ChannelCount * IR_KoBlockSize) ? (number - IR_KoBlockOffset) / IR_KoBlockSize : -1)

#define IR_KocControl 0

// IR-Taste: {{0:%C%}}
#define KoIR_cControl                            (knx.getGroupObject(IR_KoCalcNumber(IR_KocControl)))

#define BTN_ReactionTimeMultiClick              247      // 8 Bits, Bit 7-0
#define BTN_ReactionTimeLong                    248      // 8 Bits, Bit 7-0
#define BTN_ReactionTimeExtraLong               249      // 8 Bits, Bit 7-0
#define BTN_VisibleChannels                     250      // uint8_t
...
// Parameter per channel
#define BTN_ParamBlockOffset 251
...
#define LOG_BuzzerInstalled                     1311      // 1 Bit, Bit 7
#define     LOG_BuzzerInstalledMask 0x80
#define     LOG_BuzzerInstalledShift 7
#define LOG_LedInstalled                        1311      // 1 Bit, Bit 6
#define     LOG_LedInstalledMask 0x40
#define     LOG_LedInstalledShift 6
#define LOG_VacationKo                          1311      // 1 Bit, Bit 5
#define     LOG_VacationKoMask 0x20
#define     LOG_VacationKoShift 5
#define LOG_HolidayKo                           1311      // 1 Bit, Bit 4
#define     LOG_HolidayKoMask 0x10
#define     LOG_HolidayKoShift 4
#define LOG_VacationRead                        1311      // 1 Bit, Bit 3
#define     LOG_VacationReadMask 0x08
#define     LOG_VacationReadShift 3
#define LOG_HolidaySend                         1311      // 1 Bit, Bit 2
#define     LOG_HolidaySendMask 0x04
#define     LOG_HolidaySendShift 2
#define LOG_Neujahr                             1312      // 1 Bit, Bit 7
#define     LOG_NeujahrMask 0x80
#define     LOG_NeujahrShift 7
#define LOG_DreiKoenige                         1312      // 1 Bit, Bit 6
#define     LOG_DreiKoenigeMask 0x40
#define     LOG_DreiKoenigeShift 6
#define LOG_Weiberfastnacht                     1312      // 1 Bit, Bit 5
#define     LOG_WeiberfastnachtMask 0x20
#define     LOG_WeiberfastnachtShift 5
#define LOG_Rosenmontag                         1312      // 1 Bit, Bit 4
#define     LOG_RosenmontagMask 0x10
#define     LOG_RosenmontagShift 4
#define LOG_Fastnachtsdienstag                  1312      // 1 Bit, Bit 3
#define     LOG_FastnachtsdienstagMask 0x08
#define     LOG_FastnachtsdienstagShift 3
#define LOG_Aschermittwoch                      1312      // 1 Bit, Bit 2
#define     LOG_AschermittwochMask 0x04
#define     LOG_AschermittwochShift 2
#define LOG_Frauentag                           1312      // 1 Bit, Bit 1
#define     LOG_FrauentagMask 0x02
#define     LOG_FrauentagShift 1
#define LOG_Gruendonnerstag                     1312      // 1 Bit, Bit 0
#define     LOG_GruendonnerstagMask 0x01
#define     LOG_GruendonnerstagShift 0
#define LOG_Karfreitag                          1313      // 1 Bit, Bit 7
#define     LOG_KarfreitagMask 0x80
#define     LOG_KarfreitagShift 7
#define LOG_Ostersonntag                        1313      // 1 Bit, Bit 6
#define     LOG_OstersonntagMask 0x40
#define     LOG_OstersonntagShift 6
#define LOG_Ostermontag                         1313      // 1 Bit, Bit 5
#define     LOG_OstermontagMask 0x20
#define     LOG_OstermontagShift 5
#define LOG_TagDerArbeit                        1313      // 1 Bit, Bit 4
#define     LOG_TagDerArbeitMask 0x10
#define     LOG_TagDerArbeitShift 4
#define LOG_Himmelfahrt                         1313      // 1 Bit, Bit 3
#define     LOG_HimmelfahrtMask 0x08
#define     LOG_HimmelfahrtShift 3
#define LOG_Pfingstsonntag                      1313      // 1 Bit, Bit 2
#define     LOG_PfingstsonntagMask 0x04
#define     LOG_PfingstsonntagShift 2
#define LOG_Pfingstmontag                       1313      // 1 Bit, Bit 1
#define     LOG_PfingstmontagMask 0x02
#define     LOG_PfingstmontagShift 1
#define LOG_Fronleichnam                        1313      // 1 Bit, Bit 0
#define     LOG_FronleichnamMask 0x01
#define     LOG_FronleichnamShift 0
#define LOG_Friedensfest                        1314      // 1 Bit, Bit 7
#define     LOG_FriedensfestMask 0x80
#define     LOG_FriedensfestShift 7
#define LOG_MariaHimmelfahrt                    1314      // 1 Bit, Bit 6
#define     LOG_MariaHimmelfahrtMask 0x40
#define     LOG_MariaHimmelfahrtShift 6
#define LOG_DeutscheEinheit                     1314      // 1 Bit, Bit 5
#define     LOG_DeutscheEinheitMask 0x20
#define     LOG_DeutscheEinheitShift 5
#define LOG_Reformationstag                     1314      // 1 Bit, Bit 4
#define     LOG_ReformationstagMask 0x10
#define     LOG_ReformationstagShift 4
#define LOG_Allerheiligen                       1314      // 1 Bit, Bit 3
#define     LOG_AllerheiligenMask 0x08
#define     LOG_AllerheiligenShift 3
#define LOG_BussBettag                          1314      // 1 Bit, Bit 2
#define     LOG_BussBettagMask 0x04
#define     LOG_BussBettagShift 2
#define LOG_Advent1                             1314      // 1 Bit, Bit 1
#define     LOG_Advent1Mask 0x02
#define     LOG_Advent1Shift 1
#define LOG_Advent2                             1314      // 1 Bit, Bit 0
#define     LOG_Advent2Mask 0x01
#define     LOG_Advent2Shift 0
#define LOG_Advent3                             1315      // 1 Bit, Bit 7
#define     LOG_Advent3Mask 0x80
#define     LOG_Advent3Shift 7
#define LOG_Advent4                             1315      // 1 Bit, Bit 6
#define     LOG_Advent4Mask 0x40
#define     LOG_Advent4Shift 6
#define LOG_Heiligabend                         1315      // 1 Bit, Bit 5
#define     LOG_HeiligabendMask 0x20
#define     LOG_HeiligabendShift 5
#define LOG_Weihnachtstag1                      1315      // 1 Bit, Bit 4
#define     LOG_Weihnachtstag1Mask 0x10
#define     LOG_Weihnachtstag1Shift 4
#define LOG_Weihnachtstag2                      1315      // 1 Bit, Bit 3
#define     LOG_Weihnachtstag2Mask 0x08
#define     LOG_Weihnachtstag2Shift 3
#define LOG_Silvester                           1315      // 1 Bit, Bit 2
#define     LOG_SilvesterMask 0x04
#define     LOG_SilvesterShift 2
#define LOG_Nationalfeiertag                    1315      // 1 Bit, Bit 1
#define     LOG_NationalfeiertagMask 0x02
#define     LOG_NationalfeiertagShift 1
#define LOG_MariaEmpfaengnis                    1315      // 1 Bit, Bit 0
#define     LOG_MariaEmpfaengnisMask 0x01
#define     LOG_MariaEmpfaengnisShift 0
#define LOG_NationalfeiertagSchweiz             1316      // 1 Bit, Bit 7
#define     LOG_NationalfeiertagSchweizMask 0x80
#define     LOG_NationalfeiertagSchweizShift 7
#define LOG_Totensonntag                        1316      // 1 Bit, Bit 6
#define     LOG_TotensonntagMask 0x40
#define     LOG_TotensonntagShift 6
#define LOG_BuzzerSilent                        1317      // uint16_t
#define LOG_BuzzerNormal                        1319      // uint16_t
#define LOG_BuzzerLoud                          1321      // uint16_t
#define LOG_VisibleChannels                     1323      // uint8_t
#define LOG_LedMapping                          1324      // 3 Bits, Bit 7-5
#define     LOG_LedMappingMask 0xE0
#define     LOG_LedMappingShift 5
#define LOG_UserFormula1                        1325      // char*, 99 Byte
#define LOG_UserFormula1Active                  1424      // 1 Bit, Bit 7
#define     LOG_UserFormula1ActiveMask 0x80
#define     LOG_UserFormula1ActiveShift 7
#define LOG_UserFormula2                        1425      // char*, 99 Byte
#define LOG_UserFormula2Active                  1524      // 1 Bit, Bit 7
#define     LOG_UserFormula2ActiveMask 0x80
#define     LOG_UserFormula2ActiveShift 7
#define LOG_UserFormula3                        1525      // char*, 99 Byte
#define LOG_UserFormula3Active                  1624      // 1 Bit, Bit 7
#define     LOG_UserFormula3ActiveMask 0x80
#define     LOG_UserFormula3ActiveShift 7
#define LOG_UserFormula4                        1625      // char*, 99 Byte
#define LOG_UserFormula4Active                  1724      // 1 Bit, Bit 7
#define     LOG_UserFormula4ActiveMask 0x80
#define     LOG_UserFormula4ActiveShift 7
#define LOG_UserFormula5                        1725      // char*, 99 Byte
#define LOG_UserFormula5Active                  1824      // 1 Bit, Bit 7
#define     LOG_UserFormula5ActiveMask 0x80
#define     LOG_UserFormula5ActiveShift 7
#define LOG_UserFormula6                        1825      // char*, 99 Byte
#define LOG_UserFormula6Active                  1924      // 1 Bit, Bit 7
#define     LOG_UserFormula6ActiveMask 0x80
#define     LOG_UserFormula6ActiveShift 7
#define LOG_UserFormula7                        1925      // char*, 99 Byte
#define LOG_UserFormula7Active                  2024      // 1 Bit, Bit 7
#define     LOG_UserFormula7ActiveMask 0x80
#define     LOG_UserFormula7ActiveShift 7
#define LOG_UserFormula8                        2025      // char*, 99 Byte
#define LOG_UserFormula8Active                  2124      // 1 Bit, Bit 7
#define     LOG_UserFormula8ActiveMask 0x80
#define     LOG_UserFormula8ActiveShift 7
#define LOG_UserFormula9                        2125      // char*, 99 Byte
#define LOG_UserFormula9Active                  2224      // 1 Bit, Bit 7
#define     LOG_UserFormula9ActiveMask 0x80
#define     LOG_UserFormula9ActiveShift 7
#define LOG_UserFormula10                       2225      // char*, 99 Byte
#define LOG_UserFormula10Active                 2324      // 1 Bit, Bit 7
#define     LOG_UserFormula10ActiveMask 0x80
#define     LOG_UserFormula10ActiveShift 7
#define LOG_UserFormula11                       2325      // char*, 99 Byte
#define LOG_UserFormula11Active                 2424      // 1 Bit, Bit 7
#define     LOG_UserFormula11ActiveMask 0x80
#define     LOG_UserFormula11ActiveShift 7
#define LOG_UserFormula12                       2425      // char*, 99 Byte
#define LOG_UserFormula12Active                 2524      // 1 Bit, Bit 7
#define     LOG_UserFormula12ActiveMask 0x80
#define     LOG_UserFormula12ActiveShift 7
#define LOG_UserFormula13                       2525      // char*, 99 Byte
#define LOG_UserFormula13Active                 2624      // 1 Bit, Bit 7
#define     LOG_UserFormula13ActiveMask 0x80
#define     LOG_UserFormula13ActiveShift 7
#define LOG_UserFormula14                       2625      // char*, 99 Byte
#define LOG_UserFormula14Active                 2724      // 1 Bit, Bit 7
#define     LOG_UserFormula14ActiveMask 0x80
#define     LOG_UserFormula14ActiveShift 7
#define LOG_UserFormula15                       2725      // char*, 99 Byte
#define LOG_UserFormula15Active                 2824      // 1 Bit, Bit 7
#define     LOG_UserFormula15ActiveMask 0x80
#define     LOG_UserFormula15ActiveShift 7
#define LOG_UserFormula16                       2825      // char*, 99 Byte
#define LOG_UserFormula16Active                 2924      // 1 Bit, Bit 7
#define     LOG_UserFormula16ActiveMask 0x80
#define     LOG_UserFormula16ActiveShift 7
#define LOG_UserFormula17                       2925      // char*, 99 Byte
#define LOG_UserFormula17Active                 3024      // 1 Bit, Bit 7
#define     LOG_UserFormula17ActiveMask 0x80
#define     LOG_UserFormula17ActiveShift 7
#define LOG_UserFormula18                       3025      // char*, 99 Byte
#define LOG_UserFormula18Active                 3124      // 1 Bit, Bit 7
#define     LOG_UserFormula18ActiveMask 0x80
#define     LOG_UserFormula18ActiveShift 7
#define LOG_UserFormula19                       3125      // char*, 99 Byte
#define LOG_UserFormula19Active                 3224      // 1 Bit, Bit 7
#define     LOG_UserFormula19ActiveMask 0x80
#define     LOG_UserFormula19ActiveShift 7
#define LOG_UserFormula20                       3225      // char*, 99 Byte
#define LOG_UserFormula20Active                 3324      // 1 Bit, Bit 7
#define     LOG_UserFormula20ActiveMask 0x80
#define     LOG_UserFormula20ActiveShift 7
#define LOG_UserFormula21                       3325      // char*, 99 Byte
#define LOG_UserFormula21Active                 3424      // 1 Bit, Bit 7
#define     LOG_UserFormula21ActiveMask 0x80
#define     LOG_UserFormula21ActiveShift 7
#define LOG_UserFormula22                       3425      // char*, 99 Byte
#define LOG_UserFormula22Active                 3524      // 1 Bit, Bit 7
#define     LOG_UserFormula22ActiveMask 0x80
#define     LOG_UserFormula22ActiveShift 7
#define LOG_UserFormula23                       3525      // char*, 99 Byte
#define LOG_UserFormula23Active                 3624      // 1 Bit, Bit 7
#define     LOG_UserFormula23ActiveMask 0x80
#define     LOG_UserFormula23ActiveShift 7
#define LOG_UserFormula24                       3625      // char*, 99 Byte
#define LOG_UserFormula24Active                 3724      // 1 Bit, Bit 7
#define     LOG_UserFormula24ActiveMask 0x80
#define     LOG_UserFormula24ActiveShift 7
#define LOG_UserFormula25                       3725      // char*, 99 Byte
#define LOG_UserFormula25Active                 3824      // 1 Bit, Bit 7
#define     LOG_UserFormula25ActiveMask 0x80
#define     LOG_UserFormula25ActiveShift 7
#define LOG_UserFormula26                       3825      // char*, 99 Byte
#define LOG_UserFormula26Active                 3924      // 1 Bit, Bit 7
#define     LOG_UserFormula26ActiveMask 0x80
#define     LOG_UserFormula26ActiveShift 7
#define LOG_UserFormula27                       3925      // char*, 99 Byte
#define LOG_UserFormula27Active                 4024      // 1 Bit, Bit 7
#define     LOG_UserFormula27ActiveMask 0x80
#define     LOG_UserFormula27ActiveShift 7
#define LOG_UserFormula28                       4025      // char*, 99 Byte
#define LOG_UserFormula28Active                 4124      // 1 Bit, Bit 7
#define     LOG_UserFormula28ActiveMask 0x80
#define     LOG_UserFormula28ActiveShift 7
#define LOG_UserFormula29                       4125      // char*, 99 Byte
#define LOG_UserFormula29Active                 4224      // 1 Bit, Bit 7
#define     LOG_UserFormula29ActiveMask 0x80
#define     LOG_UserFormula29ActiveShift 7
#define LOG_UserFormula30                       4225      // char*, 99 Byte
#define LOG_UserFormula30Active                 4324      // 1 Bit, Bit 7
...
// Parameter per channel
#define LOG_ParamBlockOffset 4325
...
#define BASE_KommentarModuleParamOffset 6025
